...
<html lang="en-US" dir="ltr">
  <head>
    ...
    =============================================
    -->
    <title>The Study Buddies Club Membership</title>
    <!--  
    Favicons
    =============================================
    -->
  ...
  <body data-spy="scroll" data-target=".onpage-navigation" data-offset="60">
    <main>
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="custom-collapse">
            <ul class="nav navbar-nav navbar-right">
              <li class="dropdown"><a href="admin.php" class="nav-item nav-link active">Home</a>
              ...
              <li class="dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown">About Us</a>
                <ul class="dropdown-menu">
                  <li class="dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown">About Club</a>
                    <ul class="dropdown-menu">
                      <li><a href="infoadmin.html">Club Info</a></li>
                      <li><a href="galleryadmin.html">Club Gallery</a></li>
                    </ul>
                  </li>
                  
                </ul>
              </li>
              <li class="dropdown"><a href="approve.php" class="nav-item nav-link active">Approve Member</a>
              </li>
      ...
      <section class="home-section home-fade home-full-height bg-dark-60 landing-header" id="home" data-background="assets/images/image.jpg">
        <div class="titan-caption">
          <div class="caption-content">
            <div class="container">
              <div class="font-alt mb-30 titan-title-size-4">Welcome, admin!</div>
              <div class="font-alt mt-30"><a class="btn btn-border-w btn-circle" href="approve.php"> Approve member</a></div>
            </div>
          </div>
        </div>
      </section>
