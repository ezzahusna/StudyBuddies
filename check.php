          ...
          <div class="container">
            <div class="row">
              <div class="col-sm-6 col-sm-offset-3">
                <h1 class="module-title font-alt mb-0">Check membership status</h1>
              </div>
            </div>
          </div>
        </section>
          ...
          <div class="container">
            <div class="row">
              <div class="col-sm-8 col-sm-offset-2">
                <center><h4 class="font-alt mb-0">Check your name here</h4></center><br><br><br>
              <style>
                .container{
                    width:100%;
                    height:30%;
...
$con = new PDO("mysql:host=localhost;dbname=system",'root','');

if (isset($_POST["submit"])) {
	$str = $_POST["search"];
	$sth = $con->prepare("SELECT * FROM `members` WHERE fullname = '$str'");
