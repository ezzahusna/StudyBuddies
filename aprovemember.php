...
"system") or die (mysql_error ());
                    ...
                    $sql = "SELECT username,  status FROM members WHERE username = '$username'";
                  ...
                  <?php
                    ...
                    $username = $_POST['username'];
                        ...
                        $sql = "UPDATE `members` SET `status`= 'approve' WHERE username='$username'"; 
                ...
                ?>
                  <h4 class="font-alt">Login</h4>
                        <form method="POST" action="">
                            ...
                            <div class="form-group">
                                 Status:
                                <input type="text" name="status" value="<?php echo $row['status']?>"></div>
                            <div class="form-group">
                                    <input type="submit" name="UpdateUser" value=" Update Approval ">
                                    </div>
                        </form>
                  <br><br><a href="approve.php">Back to User View</a>
