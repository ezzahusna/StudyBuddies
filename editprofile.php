          ...
          <div class="container">
            <div class="row">
              <div class="col-sm-6 col-sm-offset-3">
                <h1 class="module-title font-alt mb-0">Edit Profile</h1>
              </div>
            </div>
          </div>
        </section>
                  ...
                  <?php
                    if (isset($_POST['Update'])){
                        ...
                        //create SQL statement and run the query
                         ...
                         $sql = "UPDATE `members` SET `username`= '$username', `fullname`= '$fullname', `email`= '$email', `password`= '$password' WHERE username='$username'";
                  ...
                  <h4 class="font-alt">Login</h4>
                        <form method="POST" action="">
                            ...
                            <div class="form-group">
                                 Fullname:
                                <input type="text" name="fullname" value="<?php echo $row['fullname']?>"></div>
                            <div class="form-group">
                                 Email:
                                <input type="text" name="email" value="<?php echo $row['email']?>"></div>
                            <div class="form-group">
                                 Password:
                                <input type="text" name="password" value="<?php echo $row['password']?>"></div>
                            <div class="form-group">
                                    <input type="submit" name="Update" value=" Update Profile ">
                                    </div>
                        </form>
                  <br><br><a href="profile.php">Back to Profile</a>
