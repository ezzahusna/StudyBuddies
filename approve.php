          ...
          <div class="container">
            <div class="row">
              <div class="col-sm-6 col-sm-offset-3">
                <h1 class="module-title font-alt mb-0">Approve member</h1>
              </div>
            </div>
          </div>
        </section>
          ...
          <div class="container">
            <div class="row">
              <div class="col-sm-8 col-sm-offset-2">
                <center><h4 class="font-alt mb-0">Table of registration</h4></center><br><br><br>
                  <?php
                ...
                $sql = "SELECT username, fullname, email, role, status FROM members ";
                ...
                <?php
                   ...
                   echo "<td>" . $row["email"] . "</td>";
                        ...
                        <td>
          <a href="aprovemember.php?username=<?php echo $row['username']; ?>">Edit status</a>
